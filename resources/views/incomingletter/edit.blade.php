    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded shadow">
                ...
                <form action="{{ route('surat-masuk.update', $incomingletter->slug) }}" method="POST" class="space-y-4"
                    ...
                    <div>
                        ...
                        <select name="disposition" id="disposition" required
                            ...
                            <option value="known"
                                {{ old('disposition', $incomingletter->disposition) == 'known' ? 'selected' : '' }}>
                                Untuk
                                Diketahui</option>
                            <option value="actioned"
                                {{ old('disposition', $incomingletter->disposition) == 'actioned' ? 'selected' : '' }}>
                                Penting
                            </option>
                            <option value="archived"
                                {{ old('disposition', $incomingletter->disposition) == 'archived' ? 'selected' : '' }}>
                                Arsip
                            </option>
                        </select>
                        @error('disposition')
                    ...
                    <div>
                        ...
                        @if ($incomingletter->file_path)
                            <p class="text-sm mt-2">File saat ini:
                                <a href="{{ asset('storage/' . $incomingletter->file_path) }}"
