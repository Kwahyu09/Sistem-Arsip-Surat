    ...
    <div class="py-10 bg-gray-50 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                ...
                <a href="{{ route('users.index') }}" class="inline-block mb-6 text-indigo-600 hover:text-indigo-800 font-semibold transition duration-200">
                ...
                <form action="{{ route('users.update', $user) }}" method="POST" class="space-y-6">
                    ...
                    <div class="pt-4">
                        <button type="submit"
                            class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg transition duration-200 shadow">
                             Update
                        </button>
                    </div>
                </form>
